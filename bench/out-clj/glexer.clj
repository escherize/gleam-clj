...
(defn new*
  ...
  {:malli/schema [:=> [:cat :string] (Lexer-schema)]
   :gleam/src "bench/build/packages/glexer/src/glexer.gleam:40"}
...
(defn discard-whitespace
  ...
  {:malli/schema [:=> [:cat (Lexer-schema)] (Lexer-schema)]
   :gleam/src "bench/build/packages/glexer/src/glexer.gleam:52"}
  [lexer]
...
(defn discard-comments
  ...
  {:malli/schema [:=> [:cat (Lexer-schema)] (Lexer-schema)]
   :gleam/src "bench/build/packages/glexer/src/glexer.gleam:56"}
  [lexer]
...
(defn- length
  ...
  {:gleam/src "bench/build/packages/glexer/src/glexer.gleam:881"}
  [^java.lang.String string]
  (string/byte-size string))

(defn- some-token
  "some_token(result: #(Lexer, #(Token, Position))) -> #(Lexer, Option(#(Token, Position)))"
  {:gleam/src "bench/build/packages/glexer/src/glexer.gleam:581"}
  [result]
...
(defn- advance
  ...
  {:gleam/src "bench/build/packages/glexer/src/glexer.gleam:852"}
...
(defn- advanced
  ...
  {:gleam/src "bench/build/packages/glexer/src/glexer.gleam:856"}
...
(defn- token
  ...
  {:gleam/src "bench/build/packages/glexer/src/glexer.gleam:865"}
  [lexer token ^java.lang.String source offset]
  (-> [token (->Position (:byte-offset lexer))]
      (advanced lexer source offset)
      some-token))

(def ^{:gleam/src "bench/build/packages/glexer/src/glexer.gleam:892"} slice-bytes glexer-ffi/slice-bytes)

(defn- lex-uppercase-name
  "lex_uppercase_name(lexer: Lexer, start: Int, slice_size: Int) -> #(Lexer, String)"
  {:gleam/src "bench/build/packages/glexer/src/glexer.gleam:457"}
...
(defn- lex-lowercase-name
  ...
  {:gleam/src "bench/build/packages/glexer/src/glexer.gleam:405"}
  [lexer start slice-size]
  (let [subject (:source lexer)]
    (cond
      (.startsWith ^String subject "a")
...
(def ^{:gleam/src "bench/build/packages/glexer/src/glexer.gleam:902"} drop-byte glexer-ffi/drop-byte)

(defn- lex-string
  "lex_string(lexer: Lexer, start: Int, slice_size: Int) -> #(Lexer, Option(#(Token, Position)))"
  {:gleam/src "bench/build/packages/glexer/src/glexer.gleam:745"}
  [lexer start slice-size]
  (let [subject (:source lexer)]
    (cond
...
(defn- lex-number
  ...
  {:gleam/src "bench/build/packages/glexer/src/glexer.gleam:694"}
...
(defn- lex-hexadecimal
  ...
  {:gleam/src "bench/build/packages/glexer/src/glexer.gleam:649"}
  [lexer start slice-size]
  (let [subject (:source lexer)]
    (cond
      (.startsWith ^String subject "_")
...
(defn- lex-octal
  ...
  {:gleam/src "bench/build/packages/glexer/src/glexer.gleam:624"}
  [lexer start slice-size]
  (let [subject (:source lexer)]
    (cond
      (.startsWith ^String subject "_")
...
(defn- lex-binary
  ...
  {:gleam/src "bench/build/packages/glexer/src/glexer.gleam:607"}
  [lexer start slice-size]
  (let [subject (:source lexer)]
    (cond
      (.startsWith ^String subject "_")
...
(defn- comment
  ...
  {:gleam/src "bench/build/packages/glexer/src/glexer.gleam:588"}
  [lexer kind start]
...
(defn- skip-comment
  ...
  {:gleam/src "bench/build/packages/glexer/src/glexer.gleam:572"}
  [lexer]
  (let [[prefix suffix] (splitter/split-before (:newlines lexer)
                                               (:source lexer))
        eaten (length prefix)
...
(defn- whitespace
  ...
  {:gleam/src "bench/build/packages/glexer/src/glexer.gleam:548"}
  [lexer start slice-size]
  (let [subject (:source lexer)]
    (cond
      (.startsWith ^String subject " ")
...
(defn- lex-digits
  ...
  {:gleam/src "bench/build/packages/glexer/src/glexer.gleam:383"}
  [lexer start slice-size]
  (let [subject (:source lexer)]
    (cond
      (.startsWith ^String subject "_")
...
(defn- check-for-minus
  ...
  {:gleam/src "bench/build/packages/glexer/src/glexer.gleam:534"}
  [lexer]
  (let [subject (:source lexer)]
...
(defn- next
  ...
  {:gleam/src "bench/build/packages/glexer/src/glexer.gleam:79"}
  [lexer]
...
(defn- do-lex
  ...
  {:gleam/src "bench/build/packages/glexer/src/glexer.gleam:65"}
  [lexer tokens]
...
(defn lex
  ...
  {:malli/schema [:=> [:cat (Lexer-schema)]
   ...
   :gleam/src "bench/build/packages/glexer/src/glexer.gleam:60"}
  [lexer]
...
(defn- unescape-codepoint
  ...
  {:gleam/src "bench/build/packages/glexer/src/glexer.gleam:823"}
...
(defn- unescape-loop
  ...
  {:gleam/src "bench/build/packages/glexer/src/glexer.gleam:804"}
...
(defn unescape-string
  ...
  {:malli/schema [:=> [:cat :string] (p/result-of :string :nil)]
   :gleam/src "bench/build/packages/glexer/src/glexer.gleam:800"}
  [^java.lang.String string]
...
(defn to-source
  ...
  {:malli/schema [:=> [:cat [:sequential [:tuple (token/Token-schema) (Position-schema)]]]
                      :string]
   :gleam/src "bench/build/packages/glexer/src/glexer.gleam:843"}
