...
(defn main []
  (let [q (->Quaternion 1.0 2.0 3.0 4.0)
        ...
        r 7.0]
    (io/print-line (str "q = " (to-string q)))
    (io/print-line (str "q1 = " (to-string q1)))
    (io/print-line (str "q2 = " (to-string q2)))
    (io/print-line (str (str "r = " (float/to-string r)) "\n"))
    (io/print-line (str "norm(q) = " (float/to-string (norm q))))
    (io/print-line (str "negate(q) = " (-> (negate q) (to-string))))
    (io/print-line (str "conjugate(q) = " (-> (conjugate q) (to-string))))
    (io/print-line (str "add_scalar(q, r) = " (-> (add-scalar q r) (to-string))))
    (io/print-line (str "add(q1, q2) = " (-> (add q1 q2) (to-string))))
