...
(declare Attribute-schema Function-schema Span-schema Statement-schema AssignmentKind? UsePattern-schema Pattern-schema Expression-schema Clause? BitStringSegmentOption-schema BitArraySize-schema BitArraySizeOperator-schema BinaryOperator-schema FnParameter-schema FunctionParameter-schema AssignmentName-schema Import-schema Constant-schema UnqualifiedImport-schema Publicity-schema TypeAlias-schema CustomType-schema Variant-schema RecordUpdateField-schema VariantField-schema Field-schema Type-schema)
