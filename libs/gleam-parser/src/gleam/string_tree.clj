...
(def ^{:malli/schema [:=> [:cat [:sequential :string]] [:or ]] :gleam/src "stdlib-src/src/gleam/string_tree.gleam:69"} from-strings gleam-ffi/st-from-strings)
...
(def ^{:malli/schema [:=> [:cat :string] [:or ]] :gleam/src "stdlib-src/src/gleam/string_tree.gleam:85"} from-string gleam-ffi/st-from-string)

(def ^{:malli/schema [:=> [:cat [:or ] [:or ]] [:or ]] :gleam/src "stdlib-src/src/gleam/string_tree.gleam:61"} append-tree gleam-ffi/st-append-tree)
...
(def ^{:malli/schema [:=> [:cat [:sequential [:or ]]] [:or ]] :gleam/src "stdlib-src/src/gleam/string_tree.gleam:77"} concat gleam-ffi/st-concat)

(def ^{:malli/schema [:=> [:cat [:or ]] :string] :gleam/src "stdlib-src/src/gleam/string_tree.gleam:94"} to-string gleam-ffi/st-to-string)

(def ^{:malli/schema [:=> [:cat [:or ]] :int] :gleam/src "stdlib-src/src/gleam/string_tree.gleam:100"} byte-size gleam-ffi/st-byte-size)
...
(def ^{:malli/schema [:=> [:cat [:or ]] [:or ]] :gleam/src "stdlib-src/src/gleam/string_tree.gleam:115"} lowercase gleam-ffi/st-lowercase)

(def ^{:malli/schema [:=> [:cat [:or ]] [:or ]] :gleam/src "stdlib-src/src/gleam/string_tree.gleam:122"} uppercase gleam-ffi/st-uppercase)
...
(def ^{:malli/schema [:=> [:cat [:or ] :string :string] [:or ]] :gleam/src "stdlib-src/src/gleam/string_tree.gleam:156"} replace gleam-ffi/st-replace)
